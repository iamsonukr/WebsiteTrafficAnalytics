...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | PayTrack Analytics - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for PayTrack Analytics - React.js Tailwind CSS Admin Dashboard Template"
      />
