...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | PayTrack Analytics - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for PayTrack Analytics - React.js Tailwind CSS Admin Dashboard Template"
      />
