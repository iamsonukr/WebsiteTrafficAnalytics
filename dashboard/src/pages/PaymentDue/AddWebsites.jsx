...
const AddWebsites = ({ isOpen, onClose, paymentData = null, onSuccess }) => {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 dark:text-white  rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-500"
                        />
                        {errors.clientName && (
